...
import com.kodilla.patterns2.decorator.taxiportal.additional.services.ChildSeatDecorator;
import com.kodilla.patterns2.decorator.taxiportal.additional.services.ExpressDecorator;
import com.kodilla.patterns2.decorator.taxiportal.additional.services.VipCarDecorator;
...
class TaxiOrderTestSuite {                               // [5]
    ...
    public void testMyTaxiWithChildSeatGetCost() {
        ...
        theOrder = new ChildSeatDecorator(theOrder);                    //Dodanie dwóch dekoratorów
        //When
        BigDecimal theCost = theOrder.getCost();
        //Then
    ...
    public void testVipTaxiWithChildSeatExpressGetCost() {
        ...
        theOrder = new VipCarDecorator(theOrder);                   // testowanie wielu dekoratorów,
        theOrder = new ChildSeatDecorator(theOrder);                 // ważna jest kolejność!!
